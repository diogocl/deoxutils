...
#         FILE: jpeg2avi.sh
#        USAGE: jpeg2avi
#               [jpeg_path] [start_index] [fps] [bitrate-kbps] [output_file]
...
gst-launch-1.0 multifilesrc location="$1/%05d.jpeg" start-index=$2 \
  caps=image/jpeg,framerate=$3/1 ! jpegdec ! x264enc bitrate=$4 ! \
  avimux ! filesink location="$5"
